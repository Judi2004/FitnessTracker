<style>
    .login-container {
        background-image: url("fitnessimages/fitnessmain.jpg");
...
{{-- newly added --}}
            ...
            <div>
                ...
                <x-input id="dob" class="block w-full mt-1" type="date" name="dob" :value="old('dob')" required autofocus autocomplete="dob" />
            </div>
